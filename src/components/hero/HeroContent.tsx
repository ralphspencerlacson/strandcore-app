...
import { createHeroReveal } from './hero.motion'
import type { HeroPhase, HeroStat } from './hero.types'

export default function HeroContent({ phase, reducedMotion, stats }: {
  phase: HeroPhase
...
<div className="hero-content" inert={intro}>
          <motion.p className="eyebrow" {...reveal(0)}><span className="eyebrow-dash" />Software studio <span className="separator">/</span> Metro Manila <span className="separator">/</span> GMT+8</motion.p>
          <motion.h1 id="hero-title" {...reveal(1)}>Four strands.<br />One <span>core</span>.</motion.h1>
