...
export default function Core({ phase, reducedMotion }: { phase: HeroPhase; reducedMotion: boolean }) {
  ...
  return (
    <motion.svg className="living-core" viewBox="-105 -105 210 210" fill="none" aria-hidden="true"
      ...
      <circle className="core-surface" r="37" fill="url(#core-fill)" stroke="#a1deff" strokeWidth="1.5" />
    </motion.svg>
  )
}
